...
public class SpeedometerViewRaw extends ConstraintLayout {
    ...
    public SpeedometerViewRaw(Context context)
    {
        super(context);
        initControl(context);
    }

    public SpeedometerViewRaw(Context context, AttributeSet attrs) {
        super(context, attrs);
        initControl(context);
    }

    public SpeedometerViewRaw(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initControl(Context context)
    {
        ...
        inflater.inflate(R.layout.control_speedometer_raw, this);
